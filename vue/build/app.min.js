...
exports.default = new _vueRouter2.default({
     //mode: 'history',
     base: __dirname,
     routes: [{ path: '/', component: _Home2.default }, { path: '/page', component: _Urls2.default }, { path: '/visuals', component: _Visuals2.default, name: 'home' }, { path: '/visuals/add', component: _VisualForm2.default }, { path: '/visuals/edit/:id', component: _VisualForm2.default, name: 'edit' }, { path: '/visuals/:id/song/add', component: _SongForm2.default, name: 'addSong' }, { path: '/song/:id/edit', component: _SongForm2.default, name: 'editSong' }]
});
