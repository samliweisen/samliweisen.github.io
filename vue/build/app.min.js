...
exports.default = new _vueRouter2.default({
     //mode: 'history',
     base: __dirname,
     routes: [{ path: '/', component: _Home2.default }, { path: '/page', component: _Urls2.default }, { path: '/visuals', component: _Visuals2.default, name: 'home' }, { path: '/visuals/add', component: _VisualForm2.default }, { path: '/visuals/edit/:id', component: _VisualForm2.default, name: 'edit' }]
});
...
var update = __webpack_require__(5)("621642ab", content, false);
                        ...
                        [
                          ...
                          _c("a", [
                            _c("img", {
                              ...
                              attrs: {
                                src:
                                  "https://icons.iconarchive.com/icons/danleech/simple/512/imdb-icon.png",
                                alt: "imdb icon"
                              }
                            }),
                            _vm._v(" "),
                          ...
                          _c(
                            ...
                            [
                              _c(
                                ...
                                {
                                  staticClass:
                                    "visual__progress-episode current"
                                },
                              ...
                              _c(
                                "span",
                                {
                                  staticClass: "visual__progress-episode total"
                                },
                                [_vm._v(_vm._s(v.episodes))]
                              ),
                              _vm._v(" "),
    ...
    methods: {
        ...
        renderDouban: function renderDouban() {
            ...
            this.$http.jsonp('https://api.douban.com/v2/movie/subject/' + this.visual.douban_id).then(function (res) {
                ...
                console.log(res);
                var douban = res.body;
                _this3.visual.title = douban.title;
                _this3.visual.summary = douban.summary;
                _this3.visual.poster = douban.images.large;
                _this3.visual.douban_rating = douban.rating.average;
            }, function (res) {
                //error
            });
        },
        getImdbId: function getImdbId() {
            ...
            this.$http.get(this.$store.state.api.visualImdb, options).then(function (res) {
                _this4.visual.imdb_id = res.body.imdb_id;
                _this4.renderIMDB();
            }, function (res) {});
        },
        renderIMDB: function renderIMDB() {
            ...
            this.$http.jsonp('https://www.omdbapi.com/', options).then(function (res) {
                console.log(res);
                _this5.visual.original_title = res.body.Title;
                _this5.visual.imdb_rating = res.body.imdbRating;
                _this5.visual.rotten_rating = res.body.Ratings[1].Value.replace('%', '');
                _this5.visual.poster = res.body.Poster;
                _this5.visual.release_date = res.body.Year;
            });
        }
    }
};
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__node_modules_vue_loader_lib_template_compiler_index_id_data_v_7ba5bd90_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_App_vue__ = __webpack_require__(33);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
