...
exports.default = new _vueRouter2.default({
     //mode: 'history',
     base: __dirname,
     routes: [{ path: '/', component: _Home2.default }, { path: '/page', component: _Urls2.default }, { path: '/visuals', component: _Visuals2.default, name: 'home' }, { path: '/visuals/add', component: _VisualForm2.default }, { path: '/visuals/edit/:id', component: _VisualForm2.default, name: 'edit' }, { path: '/visuals/:id/song/add', component: _SongForm2.default, name: 'addSong' }, { path: '/song/:songId/edit', component: _SongForm2.default, name: 'editSong' }, { path: '/visuals/:id/image/add', component: _ImageForm2.default, name: 'addImage' }]
});
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("h2", [_vm._v("I have watched " + _vm._s(_vm.list.length))]),
      _vm._v(" "),
      _vm.list.length == 0
                    ...
                    [
                      _c(
                        ...
                        [
                          _c(
                            "span",
                            { staticClass: "visual__progress-episodes" },
                            [
                              _vm._v(
                                _vm._s(v.current_episode) +
                                  " / " +
                                  _vm._s(v.episodes)
                              )
                            ]
                          ...
                          _vm._v(" "),
                          _c("span", { staticClass: "visual__status" }, [
                            _vm._v(_vm._s(_vm.getStatus(v)))
                          ]),
                          _vm._v(" "),
                          _c("img", {
                      ...
                      _vm._v(" "),
                      _c("mu-card-actions", [
                        _c("div", { staticClass: "visual__titles" }, [
                          _c("h3", { staticClass: "visual__title" }, [
                            _vm._v(
                              _vm._s(
                                v.original_title ? v.original_title : v.title
                              )
                            )
                          ])
                        ]),
    ...
    methods: {
        ...
        getImdbId: function getImdbId() {
            ...
            this.$http.get(this.$store.state.api.visualImdb, options).then(function (res) {
                ...
                _this5.release_dates = res.body.release_dates;
                _this5.renderIMDB();
            }, function (res) {});
        },
...
var render = function() {
  ...
  return _c(
    ...
    [
      ...
      _c("h1", [
        _vm._v(
          _vm._s(this.$store.state.languages[this.$store.state.lang].title)
        )
      ]),
      _vm._v(" "),
